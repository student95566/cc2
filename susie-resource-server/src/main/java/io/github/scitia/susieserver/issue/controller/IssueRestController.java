package io.github.scitia.susieserver.issue.controller;
...
public class IssueRestController {
    ...
    @PostMapping("/clone-issue/{issueID}")
    public ResponseEntity<IssueDTO> cloneIssue(@PathVariable Integer issueID) {
        return ResponseEntity.status(HttpStatus.CREATED).body(issueService.cloneIssue(issueID));
    }
